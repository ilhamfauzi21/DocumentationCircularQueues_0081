 ...
 * Project int merupakan project struktur data 
 * menggunakan struktur data queues dengan mendekatkan circular arrays.
 * 
 * @section Operations
 * Project int memiliki beberapa operasi antara lain :
 * 1. Insert
 * 2. Delete
 * 3. Display 
 * 
 ...
 * @date 2025-06-04
 * 
 * @copyright ilham.fauzi.ft21@mail.umy.ac.id (c) 2025
 * 
 */
...
/**
 * @brief method utama menjelaskan  program
 *
 * @return int
 */
int main()
